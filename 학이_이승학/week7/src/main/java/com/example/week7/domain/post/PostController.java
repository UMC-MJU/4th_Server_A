...
import com.example.test_week7.domain.member.MemberService;
...
import static com.example.test_week7.domain.response.Response.success;
import static com.example.test_week7.domain.response.SuccessMessage.*;
